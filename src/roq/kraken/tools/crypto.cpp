...
std::string Crypto::create_headers([[maybe_unused]] web::http::Method method, std::string_view const &path, std::string_view const &body) {
  ...
  std::string sign_2;
  utils::codec::Base64::encode(sign_2, digest_2, false, false);
  return fmt::format(
      "API-Key: {}\r\n"
      "API-Sign: {}\r\n"sv,
      key_,
