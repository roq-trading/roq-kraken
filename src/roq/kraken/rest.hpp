...
struct Rest final : public web::rest::Client::Handler {
 ...
 protected:
  ...
  void get_assets();
  void get_assets_ack(Trace<web::rest::Response> const &, uint32_t sequence);
  void operator()(Trace<json::Assets> const &);
 ...
 private:
  ...
  struct {
    utils::metrics::Profile assets, assets_ack, asset_pairs, asset_pairs_ack;
  } profile_;
  struct {
